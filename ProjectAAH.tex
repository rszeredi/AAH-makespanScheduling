...
\end{subtable}
\caption{The average ratio minus 1 of our simulated annealing solution to the optimal solution (by CP), for instances that were solved to optimality within 5 minutes.}
